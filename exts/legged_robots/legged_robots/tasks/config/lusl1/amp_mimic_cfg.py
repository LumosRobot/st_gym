...
# 21 joints
motion_files=glob.glob(os.getenv("HOME")+"/workspace/lumos_ws/humanoid_demo_retarget/sources/data/motions/lusl1_joint21/pkl/dance1_subject2_fps25.pkl")
...
all_joint_names = lusl1_21joint_names if using_21_joint else lusl1_27joint_names
...
feet_stumble_weight = -50.0

track_lin_vel_xy_weight = 2
...
policy_name = "AmpActorCriticRecurrent"  # "ActorCritic" #"ActorCriticRecurrent"
